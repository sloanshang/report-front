<template>
  <div class="content-wrapper" style="min-height: 667px;padding:50px 15px;">
    ...
    <div  v-if="tableFlag">
      <div>
        <h1 style="font-size: 1.5em;text-align: center;" id="tabletitle">{{$t('message.titleGrowerReport03')}}</h1>
  ...
  export default {
    ...
    data () {
      return {
        ...
        tableFlag: false,
        flock: '',
        filename: this.$t('message.titleGrowerReport03')
      }
    },
    methods: {
      loading: function (a) {
...
//    获取表格数据
      getData (batch) {
        var _self = this
        console.log(_self.filename + 'xxxxxx')
