...
<script>
  export default {
    ...
    computed: {
      ...
      inputRecord () {
        return '/index.html?' + (new Date()).valueOf()
      },
      reportUrl () {
      ...
      aboutToMeUrl () {
        return '/about/' + this.moduleUrl + '/index'
      }
    }
  }
</script>
