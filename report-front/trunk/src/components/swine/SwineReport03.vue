    ...
    <div v-show="tableFlag && datas.length !== 0" style="">
      <table id="fHeader" class="table table-bordered table-hover table-striped">
        ...
        <tr>
          ...
          <th>{{tableTh.date_column_11_min_date}}<br>{{tableTh.date_column_11_max_date}}</th>
          <th>{{tableTh.date_column_12_min_date}}<br>{{tableTh.date_column_12_max_date}}</th>
      ...
      <table v-show="device=='PC'" id="sTable" class="table table-bordered table-hover table-striped">
        ...
        <tr v-for="data in datas">
          ...
          <td>{{data.sub_category == '10.1000' || data.sub_category =='20.0000' || data.sub_category =='20.1000' || data.sub_category =='30.0000' || data.sub_category =='30.1000' || data.sub_category =='40.0000' || data.sub_category =='40.1000'?' ': data.column_11}}</td>
          <td>{{data.sub_category == '10.1000' || data.sub_category =='20.0000' || data.sub_category =='20.1000' || data.sub_category =='30.0000' || data.sub_category =='30.1000' || data.sub_category =='40.0000' || data.sub_category =='40.1000'?' ': data.column_12}}</td>
        ...
        <tr v-for="data in datas">
          <td>
            <div class="card-views">
              ...
              <div class="card-view">
                <span class="title"> {{tableTh.date_column_10_min_date}}<br>{{tableTh.date_column_10_max_date}} </span>
                <span class="value"> {{data.column_11}} </span>
              </div>
              <div class="card-view">
                <span class="title"> {{tableTh.date_column_10_min_date}}<br>{{tableTh.date_column_10_max_date}} </span>
                <span class="value"> {{data.column_12}} </span>
              </div>
              <div class="card-view">
